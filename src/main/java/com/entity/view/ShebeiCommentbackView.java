...
public class ShebeiCommentbackView extends ShebeiCommentbackEntity implements Serializable {
	...
	public ShebeiCommentbackView() {

	}

	public ShebeiCommentbackView(ShebeiCommentbackEntity shebeiCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, shebeiCommentbackEntity);
