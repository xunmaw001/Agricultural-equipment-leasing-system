...
var centerMenu = [
    ...
    ,{
        name: '设备收藏',
        url: '../shebeiCollection/list.html'
    }
    ,{
        name: '设备订单',
        url: '../shebeiOrder/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/nongyeshebeizulin/admin/dist/index.html#/login";
